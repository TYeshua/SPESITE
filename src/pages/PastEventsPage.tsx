    ...
    <>
      ...
      <section className="py-16 md:py-24 dark:bg-gray-800">
        <div className="container mx-auto px-4">
          {/* Search and Filters */}
          <div className="mb-12 bg-white dark:bg-gray-700 rounded-lg shadow-md p-6">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div>
                <div className="relative">
                  <select
                    className="w-full appearance-none pl-10 pr-10 py-3 border border-gray-300 dark:border-gray-600 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 bg-white dark:bg-gray-800 text-gray-900 dark:text-white"
