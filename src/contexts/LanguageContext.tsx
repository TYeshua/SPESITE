...
const translations = {
  pt: {
    ...
    'news.item1.title': 'Processo Seletivo SPE UFPA',
    'news.item1.desc': 'Quer desenvolver habilidades, ampliar seu networking e viver experiências que vão além da sala de aula? Então essa é sua chance!',
    'news.item1.date': '24 de Fevereiro',
    'news.item2.title': 'Comemoração 1 Ano de SPE UFPA',
    'news.item2.desc': 'Chegou o momento de celebrar nossa trajetória e brindar a cada meta batida. Foram meses de dedicação que transformaram nosso capítulo em uma referência de união e conhecimento.',
    'news.item2.date': '28 de Fevereiro',
    'news.item3.title': 'Dia das Mulheres',
    'news.item3.desc': 'Hoje celebramos a força, a dedicação e a trajetória de mulheres que inspiram, transformam e deixam sua marca todos os dias.',
    'news.item3.date': '08 de Março',
    'news.item4.title': 'Próximas Etapas no Processo Seletivo',
    'news.item4.desc': 'A primeira terá início no dia 10/03 com as entrevistas. E no dia 16/03 terão início as dinâmicas em grupo. Fique atento!',
    'news.item4.date': '10 de Março',
  ...
  en: {
    ...
    'news.item1.title': 'SPE UFPA Selection Process',
    'news.item1.desc': 'Want to develop skills, expand your network, and live experiences that go beyond the classroom? Then this is your chance!',
    'news.item1.date': 'February 24th',
    'news.item2.title': 'SPE UFPA 1-Year Anniversary',
    'news.item2.desc': 'It is time to celebrate our journey and toast to every goal achieved. There were months of dedication that transformed our chapter into a benchmark of unity and knowledge.',
    'news.item2.date': 'February 28th',
    'news.item3.title': "Women's Day",
    'news.item3.desc': 'Today we celebrate the strength, dedication, and journey of women who inspire, transform, and leave their mark every day.',
    'news.item3.date': 'March 8th',
    'news.item4.title': 'Next Steps in the Selection Process',
    'news.item4.desc': 'The first will start on March 10th with interviews. And on March 16th the group dynamics will begin. Stay tuned!',
    'news.item4.date': 'March 10th',
