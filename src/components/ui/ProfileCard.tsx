...
const ProfileCardComponent: React.FC<ProfileCardProps> = ({
  ...
  const getOffsets = (_evt: PointerEvent, el: HTMLElement): { x: number; y: number } => {
    const rect = el.getBoundingClientRect();
    return { x: (_evt as PointerEvent).clientX - rect.left, y: (_evt as PointerEvent).clientY - rect.top };
  };
