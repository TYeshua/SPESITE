            ...
            >
              ...
              <div className="nav-card-links mt-auto flex flex-col gap-[2px]">
                {item.links?.map((lnk, i) => {
                  ...
                  return isInternal ? (
                    <Link key={`${lnk.label}-${i}`} to={lnk.href} {...commonProps}>
                      <GoArrowUpRight className="nav-card-link-icon shrink-0" aria-hidden="true" />
                      {lnk.label}
                    </Link>
                  ) : (
                    <a key={`${lnk.label}-${i}`} href={lnk.href} target="_blank" rel="noopener noreferrer" {...commonProps}>
                      <GoArrowUpRight className="nav-card-link-icon shrink-0" aria-hidden="true" />
                      {lnk.label}
                    </a>
                  );
